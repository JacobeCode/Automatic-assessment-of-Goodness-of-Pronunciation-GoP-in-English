...
data=/net/pr2/projects/plgrid/plggdspmwit/plgkgucik/data_librispeech_model
...
if [ $stage -le 20 ]; then
  ...
  local/nnet3/run_tdnn.sh # set "--stage 11" if you have already run local/nnet3/run_tdnn.sh
fi
